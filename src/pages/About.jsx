       ...
       <div className="intro-box">
        ...
        <div className="content-wrapper">
          ...
          <div className="text-content">
            <h1 className='text-red-500'>Welcome to Hometeam</h1>
...
HomeTeam quantifies household labor so you can have constructive conversations. Each partner independently reports their time spent on tasks and planning responsibilities.
              <br /><br/>
              <strong>The result?</strong> A clear visual breakdown of who's doing what—and who's managing it all. No more guessing. Just data that helps you rebalance together.</p><br/>
            <p><strong>ready to see your household split?</strong></p>
          </div>
        </div>
